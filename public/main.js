...
const drawFive = () => {
  axios.get(`${API_BASE_URL}/api/robots/five`).then((res) => {
...
const duel = () => {
  ...
  setTimeout(() => {
    axios
      .post(`${API_BASE_URL}/api/duel`, { compDuo, playerDuo })
      .then(({ data }) => {
...
const getPlayerStats = () => {
  axios.get(`${API_BASE_URL}/api/player`).then(({ data: { wins, losses } }) => {
...
const getAllBots = () => {
  axios.get(`${API_BASE_URL}/api/robots`).then(({ data }) => {
